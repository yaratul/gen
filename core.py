...
def check_card(card_number, exp_month, exp_year, cvc):
    ...
    try:
        ...
        response2 = requests.post(url2, cookies=cookies, headers=headers2, json=json_data, proxies={"http": PROXY_URL, "https": PROXY_URL})
